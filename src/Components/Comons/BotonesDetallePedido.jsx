...
const BotonesDetallePedido = ({ estadoPedido, pedido, onCancelarPedido, onPrepararPedido, onControlarPedido, onDespacharPedido, onEntregarPedido, onDevolverPedido, onImprimirPedido
}) => {
    ...
    return (
        ...
        >
            ...
            <ButtonFormulario variant="contained" color="primary" onClick={onImprimirPedido} >Imprimir</ButtonFormulario>
